...
We use gitter.im. There is a [general chat](https://gitter.im/solid/chat) as well as chats about specific products such as [node-solid-server](https://gitter.im/solid/node-solid-server).
